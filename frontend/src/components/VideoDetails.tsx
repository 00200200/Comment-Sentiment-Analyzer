	...
	return (
		<section className='mt-4 mb-8'>
			...
			<div className='grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-xl mx-auto mt-4'>
				{/* Views */}
				<StatBlock label='Views' value={view_count.toLocaleString()} change={view_change_pct} isPositiveChange={true} />

				{/* Comments */}
				<StatBlock label='Comments' value={comment_count.toLocaleString()} sublabel='Average ratio' />
				...
				{/* Thumbs Up */}
				<StatBlock label='Thumbs' value={like_count.toLocaleString()} sublabel='Up' />

				{/* Thumbs Down */}
				<StatBlock label='' value={dislike_count.toLocaleString()} sublabel='Down' />
